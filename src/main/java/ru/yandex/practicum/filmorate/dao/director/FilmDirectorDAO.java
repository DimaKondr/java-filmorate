...
public class FilmDirectorDAO implements DirectorDAO {
    ...
    public List<Film> getFilmsByDirectorSortedByYear(Long directorId) {
        ...
        try {
            ...
            log.error("Ошибка при получении фильмов режиссера по году {}: {}", directorId, e.getMessage());
    ...
    public List<Film> getFilmsByDirectorSortedByLikes(Long directorId) {
        ...
        try {
            ...
            log.error("Ошибка при получении фильмов режиссера по лайкам {}: {}", directorId, e.getMessage());
            throw new DataBaseException("Не удалось получить фильмы режиссера");
        }
    }
